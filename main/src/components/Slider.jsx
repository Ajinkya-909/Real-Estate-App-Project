    ...
    <>
      <div className="border-4 relative w-11/12 p-5 mt-4 m-auto flex justify-evenly items-center max-1000px:flex-col">
        ...
        <div className="z-10 backdrop-blur-xl bg-Off_White/30 rounded-3xl p-3 text-center h-full w-2/5  max-1000px:w-4/5 max-700px:hidden">
          ...
          <div className="buttons flex justify-around p-3 items-center">
            <Link to="/sign-up">
              <button className="p-4 bg-Gold rounded-3xl poppins-semibold text-xl text-center ">
                Try Now!
              </button>
            </Link>
            <Link to="/about">
              <button className="p-4 bg-black rounded-3xl text-white poppins-semibold text-xl text-center ">
                Learn More . . .
              </button>
            </Link>
          </div>
        ...
        <div className="z-10  relative ">
          <div className=" z-50 mt-48 max-700px:mt-36 max-500px:mt-12 m-auto flex justify-between gap-5 w-full absolute ">
            <button
              ...
              className="z-50 m-10 max-700px:m-5 font-sans font-bold text-2xl text-center  opacity-80 hover:opacity-100 bg-white h-16 w-7"
            >
              {arrows[1]}
            </button>
            <button
